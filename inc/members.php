    ...
    <div class="col-sm-4">
      <div class="card img-fluid" style="width:350px">
        <img class="card-img op" src="img/avatar/ant2.png" alt="Card image" style="width:100%">
          ...
          <p class="card-text bold">Team captain, known for his sport-touring riding technique. Interested in war history and dildos.</p>
        </div>
      </div>
  </div>
  <div class="col-sm-4">
    <div class="card img-fluid" style="width:350px">
      <img class="card-img op" src="img/avatar/benoAvatar.png" alt="Card image" style="width:100%">
        ...
        <p class="card-text bold">Resident artist, modern age hippie. Has an unusually attractive body (according to TRIK).</p>
      </div>
    </div>
</div>
<div class="col-sm-4">
  <div class="card img-fluid" style="width:350px">
    <img class="card-img op" src="img/avatar/pajoAvatar.png" alt="Card image" style="width:100%">
      ...
      <p class="card-text bold">Oldest and wisest member. Co-founder, involved in multiple crashes. Used to be fast.</p>
    </div>
  </div>
</div>
</div>
